...
public class Weapon : MonoBehaviour
{
    ...
    public void Use() // 무기사용 로직
    {
        ...
        {
            curAmmo--; // 현재 탄 소모
            StartCoroutine("Shot"); // Shot 애니메이션 실행
        }
    }
